...
module.exports = class EventStorage {
  analyticsApi =
    process.env.ERXES_TELEMETRY_API || `https://telemetry.erxes.io/events`

  constructor() {
    try {
      this.config = new Configstore(`erxes`, {}, { globalConfigPath: true })
    } catch (e) {
    ...
    this.verbose = isTruthy(process.env.ERXES_TELEMETRY_VERBOSE)
    this.debugEvents = isTruthy(process.env.ERXES_TELEMETRY_DEBUG)
    this.disabled = isTruthy(process.env.ERXES_TELEMETRY_DISABLED)
  }
