import { CAR_SELECT_OPTIONS } from "./resolvers/constants";
...
export const carSchema = {
  ...
  vintageYear: { type: Number, label: 'Vintage year', default: 2020 },
  importYear: { type: Number, label: 'Imported year', default: 2020 },
