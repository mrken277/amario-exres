(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('classcat'), require('@reach/popover'), require('use-onclickoutside'), require('date-fns/format'), require('date-fns/parse'), require('date-fns/isEqual'), require('date-fns/toDate'), require('date-fns/isValid'), require('date-fns/startOfDay'), require('date-fns/getHours'), require('date-fns/addHours'), require('date-fns/addMinutes'), require('date-fns/addSeconds'), require('date-fns/addMilliseconds'), require('date-fns/setHours'), require('date-fns/addDays'), require('date-fns/differenceInDays'), require('date-fns/startOfWeek'), require('date-fns/startOfMonth'), require('date-fns/endOfMonth'), require('date-fns/isSameDay'), require('date-fns/isBefore'), require('date-fns/addMonths'), require('date-fns/getDate'), require('date-fns/addYears'), require('date-fns/isSameMonth'), require('date-fns/setMonth'), require('date-fns/getDaysInMonth'), require('date-fns/setDate'), require('date-fns/getYear'), require('date-fns/setYear'), require('date-fns/getDaysInYear'), require('date-fns/setDayOfYear')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'classcat', '@reach/popover', 'use-onclickoutside', 'date-fns/format', 'date-fns/parse', 'date-fns/isEqual', 'date-fns/toDate', 'date-fns/isValid', 'date-fns/startOfDay', 'date-fns/getHours', 'date-fns/addHours', 'date-fns/addMinutes', 'date-fns/addSeconds', 'date-fns/addMilliseconds', 'date-fns/setHours', 'date-fns/addDays', 'date-fns/differenceInDays', 'date-fns/startOfWeek', 'date-fns/startOfMonth', 'date-fns/endOfMonth', 'date-fns/isSameDay', 'date-fns/isBefore', 'date-fns/addMonths', 'date-fns/getDate', 'date-fns/addYears', 'date-fns/isSameMonth', 'date-fns/setMonth', 'date-fns/getDaysInMonth', 'date-fns/setDate', 'date-fns/getYear', 'date-fns/setYear', 'date-fns/getDaysInYear', 'date-fns/setDayOfYear'], factory) :
  (global = global || self, factory(global['@nateradebaugh/react-datetime'] = {}, global.React, global.cc, global.Popover, global.useOnClickOutside, global.format, global.rawParse, global.isEqual, global.toDate, global.isDateValid, global.startOfDay, global.getHours, global.addHours, global.addMinutes, global.addSeconds, global.addMilliseconds, global.setHours, global.addDays, global.differenceInDays, global.startOfWeek, global.startOfMonth, global.endOfMonth, global.isSameDay, global.isBefore, global.addMonths, global.getDate, global.addYears, global.isSameMonth, global.setMonth, global.getDaysInMonth, global.setDate, global.getYear, global.setYear, global.getDaysInYear, global.setDayOfYear));
}(this, (function (exports, React, cc, Popover, useOnClickOutside, format, rawParse, isEqual, toDate, isDateValid, startOfDay, getHours, addHours, addMinutes, addSeconds, addMilliseconds, setHours, addDays, differenceInDays, startOfWeek, startOfMonth, endOfMonth, isSameDay, isBefore, addMonths, getDate, addYears, isSameMonth, setMonth, getDaysInMonth, setDate, getYear, setYear, getDaysInYear, setDayOfYear) { 'use strict';

  cc = cc && cc.hasOwnProperty('default') ? cc['default'] : cc;
  Popover = Popover && Popover.hasOwnProperty('default') ? Popover['default'] : Popover;
  useOnClickOutside = useOnClickOutside && useOnClickOutside.hasOwnProperty('default') ? useOnClickOutside['default'] : useOnClickOutside;
  format = format && format.hasOwnProperty('default') ? format['default'] : format;
  rawParse = rawParse && rawParse.hasOwnProperty('default') ? rawParse['default'] : rawParse;
  ...
  isDateValid = isDateValid && isDateValid.hasOwnProperty('default') ? isDateValid['default'] : isDateValid;
  ...
  addMilliseconds = addMilliseconds && addMilliseconds.hasOwnProperty('default') ? addMilliseconds['default'] : addMilliseconds;
  ...
  differenceInDays = differenceInDays && differenceInDays.hasOwnProperty('default') ? differenceInDays['default'] : differenceInDays;
  ...
  getDaysInYear = getDaysInYear && getDaysInYear.hasOwnProperty('default') ? getDaysInYear['default'] : getDaysInYear;
...
//# sourceMappingURL=react-datetime.umd.development.js.map
